...
import static com.flaminiovilla.geris.exception.ReferralPersonException.referralPersonExceptionCode.ADD_TO_REGION_FAILED;
import static com.flaminiovilla.geris.exception.StructureException.structureExceptionCode.*;
    ...
    public Structure create(StructureDTO structureDTO) {
        if (structureCheck.structureValidating(structureDTO)) {
            ...
            try {
                ...
                throw new StructureException(EXPIRE_DATA_CONVENTION_WRONG);
            }
            ...
            throw new StructureException(ILLEGAL_ARGUMENT);
        }
    }
    ...
    public Boolean delete(StructureDTO structureDTO) {
        if(deletePermit(structureDTO)) {
            try {
                ...
                throw new StructureException(STRUCTURE_DELETE_ERROR);
            }
        }
        throw new StructureException(ACTION_NOT_PERMITTED);
